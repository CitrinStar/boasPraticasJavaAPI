...
import br.com.alura.adopet.api.dto.ReprocacaoAdocaoDto;
...
import br.com.alura.adopet.api.validation.ValidadorSolcitacaoAdocao;
...
public class AdocaoService {
    ...
    @Autowired
    private List<ValidadorSolcitacaoAdocao> validacoes;
    ...
    public void reprovar(ReprocacaoAdocaoDto dto){
        Adocao adocao = adocaoRepository.getReferenceById(dto.idAdocao());
